...
def make_repeater2(f, n):
    ...
    >>> add_three(5)
    8
    >>> make_repeater2(triple, 5)(1) # 3 * 3 * 3 * 3 * 3 * 1
    243
    >>> make_repeater2(square, 2)(5) # square(square(5))
    625
    >>> make_repeater2(square, 4)(5) # square(square(square(square(5))))
    152587890625
    >>> make_repeater2(square, 0)(5) # Yes, it makes sense to apply the function zero times! 
    5
    """
    "*** YOUR CODE HERE ***"
